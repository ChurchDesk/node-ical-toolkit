...
ICSFileBuilder.prototype.generateHeader = () => {
  var lines = [];
...
ICSFileBuilder.prototype.generateEvents = function () {
  var lines = [];
...
ICSFileBuilder.prototype.generateFooter = () => {
  return this.NEWLINE_CHAR + 'END:VCALENDAR';
};

ICSFileBuilder.prototype.toString = () => {
  return [this.generateHeader(), this.generateEvents(), this.generateFooter()].join();
};
